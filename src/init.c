...
/*   Updated: 2021/08/27 16:58:08 by tschmitt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_corner_textures(t_data *data)
{
	...
	data->images[top_left].path = "./textures/corners/top_left.xpm";
...
static void	init_floor_textures(t_data *data)
{
	...
	data->images[grass_quater].path = "./textures/floor/grass_quarter.xpm";
